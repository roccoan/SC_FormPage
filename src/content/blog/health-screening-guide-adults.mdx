...
**Dental and eye check-ups** — [Dental check-ups](/blog/dental-check-frequency) (every 12 to 24 months for low-risk adults — the "every 6 months" rule has no strong clinical basis) and [eye exams](/blog/eye-exam-adults-frequency) (every two years for adults with no symptoms or risk factors, more often from age 65) are recommended continuously through adulthood. They rarely feel like "screenings," but that's exactly what they are — dental exams include oral cancer screening, and eye exams screen for glaucoma and macular degeneration.

**Skin checks** — Unlike most other cancers, most countries do not recommend routine skin cancer screening for the general population — even Australia, which has the world's highest melanoma rates. Higher-risk adults (many moles, family history of melanoma, significant sun exposure history) are generally advised to have annual checks with a dermatologist. [How often skin checks are recommended, and why the evidence picture is complicated](/blog/skin-cancer-screening-frequency), covers the full picture.

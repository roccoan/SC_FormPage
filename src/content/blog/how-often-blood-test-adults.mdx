...
For adults in England aged 40 to 74, the NHS Health Check is a free five-yearly appointment that covers many of the key blood tests and risk markers in one place — cholesterol, blood glucose, blood pressure, BMI, and cardiovascular risk. It's offered proactively through GP surgeries. Blood pressure specifically has its own screening schedule that varies by age and risk level — [how often adults should have their blood pressure checked](/blog/blood-pressure-check-frequency) covers the full guidance.
